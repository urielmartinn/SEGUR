<?php
// Editatu Diska: localhost:81/modify_item?item={x}
...
if (!$stmt->fetch()) die('Diska ez da aurkitu.');
$errors = [];
if ($_SERVER['REQUEST_METHOD']==='POST') {
    ...
    if ($title_n==='') $errors[]='Izenburua beharrezkoa.';
    if (empty($errors)) {
...
<!DOCTYPE html>
<html>
<head><meta charset="utf-8"><title>Editatu diska</title><script src="/js/validation.js"></script></head>
<body>
  <h2>Editatu diska</h2>
